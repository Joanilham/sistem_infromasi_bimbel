            ...
            <form action="{{ route('password.store') }}" method="POST" class="space-y-5">
                ...
                <div class="flex items-center pt-1">
                    <input id="show_password" type="checkbox"
                        class="h-4 w-4 rounded border-slate-300 text-orange-600 focus:ring-orange-500 transition-colors cursor-pointer"
