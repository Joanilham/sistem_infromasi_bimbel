                        ...
                        @forelse($recentPendaftaran ?? [] as $p)
                            <tr class="group hover:bg-slate-50/30 dark:hover:bg-slate-800/30 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    @endphp
                                    <a href="{{ $waLink }}" aria-label="Hubungi via WhatsApp" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-green-50 dark:bg-green-950 text-green-700 dark:text-green-400 text-[10px] font-black uppercase tracking-widest hover:bg-green-600 hover:text-white transition-all">
