...
<x-modal-form id="modal-edit" title="Edit Periode" action="">
    ...
    <div class="pd-grid" style="margin-top: 10px;">
        <div class="pd-field full">
            <label for="edit_tahun_periode">Tahun Periode <span>*</span></label>
            <input type="text" name="tahun_periode" id="edit_tahun_periode" required placeholder="Contoh: 2025/2026">
        ...
        <div class="pd-field full" style="justify-content: center; padding-top: 10px;">
            <label style="display: flex; align-items: flex-start; cursor: pointer; gap: 8px; font-weight: 600;">
                <input type="checkbox" name="is_active" id="edit_is_active" value="1" style="width: auto; margin-top: 3px; margin-right: 4px;">
                <div>
