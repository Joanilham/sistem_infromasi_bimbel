...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:1.5rem; flex-wrap:wrap; gap:0.75rem;">
    <div>
        ...
        <h1 style="font-size:1.5rem; font-weight:700; color:#0f172a; margin:0;">Scan Absen Masuk</h1>
        <p style="font-size:0.875rem; color:#64748b; margin:0.25rem 0 0;">{{ now()->translatedFormat('l, d F Y') }}</p>
    </div>
    <div style="display:flex; gap:0.5rem; flex-wrap:wrap;">
        <a href="{{ route('absensi.scan.pulang.page') }}" class="btn-add" style="background:#f8fafc; color:#475569; border:1px solid #e2e8f0; box-shadow:none;">
