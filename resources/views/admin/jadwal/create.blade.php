...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-[2.5rem] p-8 border border-slate-100 dark:border-zinc-800 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Tambah Sesi Baru</h1>
            </div>
            <p class="text-slate-500 dark:text-slate-400 text-sm font-medium ml-11">Lengkapi data jadwal belajar mengajar untuk guru dan kelas.</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-[2.5rem] p-8 border border-slate-100 dark:border-zinc-800 shadow-sm" x-data="jadwalForm()">
        <form action="{{ route('admin.jadwal.store') }}" method="POST" class="space-y-8 max-w-4xl mx-auto">
            @csrf
            ...
            <div class="flex items-center justify-end gap-4 pt-6 border-t border-slate-100 dark:border-zinc-800 mt-8">
                <a href="{{ route('admin.jadwal.index') }}" class="px-6 py-3 rounded-xl font-bold text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-zinc-800 transition-colors">
                    Batal
                </a>
