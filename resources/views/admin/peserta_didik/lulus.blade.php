...
@section('title', 'Peserta Didik Lulus')
...
<div class="space-y-6" x-data="ajaxTable()">
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-[2.5rem] p-8 border border-slate-100 dark:border-zinc-800 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div>
            <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Peserta Didik Lulus</h1>
            <p class="text-slate-500 dark:text-slate-400 mt-2 text-sm font-medium">Monitoring dan rekap data peserta didik yang sudah lulus dari lembaga.</p>
        </div>
        <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto shrink-0">
            <a href="{{ route('peserta-didik.lulus.export') }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-20 text-center border border-slate-200 dark:border-zinc-800">
                                ...
                                <p class="font-bold text-slate-600 dark:text-slate-300">Tidak ada data peserta didik lulus</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
