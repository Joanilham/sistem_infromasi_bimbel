...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Edit Paket Bimbingan</h1>
            <p class="text-slate-500 dark:text-slate-400">Perbarui informasi paket bimbingan <strong>{{ $paketBimbingan->nama_paket }}</strong>.</p>
        </div>
    ...
    <form action="{{ route('paket-bimbingan.update', $paketBimbingan->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-[2rem] shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_paket" value="{{ old('nama_paket', $paketBimbingan->nama_paket) }}" required class="w-full px-4 py-3 rounded-xl border-slate-200 dark:border-slate-800 dark:bg-slate-950 focus:ring-indigo-500 transition-all">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="nominal" value="{{ old('nominal', $paketBimbingan->nominal) }}" required class="nominal-input w-full pl-12 pr-4 py-3 rounded-xl border-slate-200 dark:border-slate-800 dark:bg-slate-950 focus:ring-indigo-500 transition-all">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-medium">Rp</span>
                                <input type="text" name="harga_coret" value="{{ old('harga_coret', $paketBimbingan->harga_coret) }}" class="nominal-input w-full pl-12 pr-4 py-3 rounded-xl border-slate-200 dark:border-slate-800 dark:bg-slate-950 focus:ring-indigo-500 transition-all">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="number" name="durasi_jumlah" value="{{ old('durasi_jumlah', $paketBimbingan->durasi_jumlah) }}" class="w-24 px-4 py-3 rounded-xl border-slate-200 dark:border-slate-800 dark:bg-slate-950 focus:ring-indigo-500 transition-all">
                        ...
                        <div>
                            ...
                            <input type="text" name="label_populer" value="{{ old('label_populer', $paketBimbingan->label_populer) }}" class="w-full px-4 py-3 rounded-xl border-slate-200 dark:border-slate-800 dark:bg-slate-950 focus:ring-indigo-500 transition-all" placeholder="Misal: Best Seller / Promo">
                ...
                <div class="pt-8 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <textarea name="deskripsi" rows="3" class="w-full px-4 py-3 rounded-xl border-slate-200 dark:border-slate-800 dark:bg-slate-950 focus:ring-indigo-500 transition-all" placeholder="Jelaskan secara singkat tentang paket ini...">{{ old('deskripsi', $paketBimbingan->deskripsi) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" name="target_peserta" value="{{ old('target_peserta', $paketBimbingan->target_peserta) }}" class="w-full px-4 py-3 rounded-xl border-slate-200 dark:border-slate-800 dark:bg-slate-950 focus:ring-indigo-500 transition-all" placeholder="Misal: Siswa SMA / Mahasiswa">
                        ...
                        <div>
                            ...
                            <input type="text" name="fasilitas" value="{{ old('fasilitas', $paketBimbingan->fasilitas) }}" class="w-full px-4 py-3 rounded-xl border-slate-200 dark:border-slate-800 dark:bg-slate-950 focus:ring-indigo-500 transition-all" placeholder="Misal: AC, WiFi, Co-working Space">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            @if($paketBimbingan->gambar_paket)
                                <div class="mb-4 relative w-32 h-32 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
                                    <img src="{{ asset('storage/' . $paketBimbingan->gambar_paket) }}" class="w-full h-full object-cover">
                                </div>
                            @endif
                        ...
                        <div class="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-2xl flex items-center h-fit mt-auto">
                            <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured', $paketBimbingan->is_featured) ? 'checked' : '' }} class="w-5 h-5 text-indigo-600 rounded-lg border-slate-300 focus:ring-indigo-500">
            ...
            <div class="bg-slate-50 dark:bg-slate-800/50 px-8 py-6 flex items-center justify-end gap-4 border-t border-slate-100 dark:border-slate-800">
                <a href="{{ route('paket-bimbingan.index') }}" class="px-6 py-2.5 rounded-xl text-sm font-semibold text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-all">
                    Batal
                </a>
