...
<head>
    ...
    @php
        ...
        $namaLembaga = $master->nama_lembaga ?? config('app.name');
    ...
    <style>
        ...
        @media print {
            @page {
                margin: 0; /* Menghilangkan header/footer bawaan browser (URL, tanggal) */
            }
            body { 
                background-color: #fff; 
                padding: 10px; 
                color: #000; /* Hitam pekat untuk thermal printer */
            }
            .receipt-container { 
                box-shadow: none; 
                border: none;
                width: 100%; 
                max-width: 80mm; /* Standar ukuran maksimal printer kasir 80mm */
                padding: 0; 
                margin: 0 auto; 
            }
            .receipt-container::before {
            ...
            /* Ubah semua warna abu-abu/warna-warni menjadi hitam/putih saat diprint */
...
<body>
    <div class="receipt-container">
        ...
        <div class="row">
            ...
            <span class="value">{{ \Carbon\Carbon::parse($transaksiPembayaran->tanggal)->translatedFormat('d F Y') }}</span>
        </div>
        <div class="row">
        ...
        <div class="total-box">
            ...
            @if($transaksiPembayaran->pembayaranSiswa && $transaksiPembayaran->pembayaranSiswa->kekurangan > 0)
                <div style="text-align: right; margin-top: 8px; font-size: 12px; color: #ef4444; font-weight: 600;">
                    Sisa Tagihan: Rp {{ number_format($transaksiPembayaran->pembayaranSiswa->kekurangan, 0, ',', '.') }}
                </div>
            @elseif($transaksiPembayaran->pembayaranSiswa && $transaksiPembayaran->pembayaranSiswa->kekurangan <= 0)
    ...
    <script>
        // Optional: Auto print if user likes, uncomment this line:
