...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="relative bg-gradient-to-br from-indigo-500 to-indigo-600 dark:from-indigo-900/40 dark:to-indigo-950/40 border border-indigo-400/20 dark:border-indigo-800/30 rounded-[2rem] p-6 shadow-xl shadow-indigo-500/10 text-white overflow-hidden group">
            ...
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    <span class="text-[10px] font-bold uppercase tracking-widest text-indigo-200">Pemasukan - {{ $selectedKantorName }}</span>
                    <h3 class="text-3xl font-black mt-2 tracking-tight">Rp {{ number_format($totalCabangIni, 0, ',', '.') }}</h3>
                    <p class="text-xs text-indigo-100/90 mt-1 font-medium flex items-center gap-1.5">
        ...
        <div class="relative bg-gradient-to-br from-emerald-500 to-emerald-600 dark:from-emerald-900/40 dark:to-emerald-950/40 border border-emerald-400/20 dark:border-emerald-800/30 rounded-[2rem] p-6 shadow-xl shadow-emerald-500/10 text-white overflow-hidden group">
            <div class="absolute -top-12 -right-12 w-40 h-40 rounded-full bg-white/5 blur-xl pointer-events-none group-hover:scale-110 transition-transform duration-500"></div>
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    <span class="text-[10px] font-bold uppercase tracking-widest text-emerald-200">Pemasukan Seluruh Cabang</span>
                    <h3 class="text-3xl font-black mt-2 tracking-tight">Rp {{ number_format($totalSeluruhCabang, 0, ',', '.') }}</h3>
                    <p class="text-xs text-emerald-100/90 mt-1 font-medium flex items-center gap-1.5">
