    ...
    <div class="mb-4">
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('paket-bimbingan.index') }}"
                class="flex items-center px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('paket-bimbingan.*') ? 'bg-orange-500 shadow-md shadow-orange-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('paket-bimbingan.*') ? 'bg-white/25' : 'bg-orange-500 shadow-sm shadow-orange-500/40' }}">
            ...
            <a href="{{ route('kelompok-belajar.index') }}"
                class="flex items-center px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('kelompok-belajar.*') ? 'bg-purple-500 shadow-md shadow-purple-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('kelompok-belajar.*') ? 'bg-white/25' : 'bg-purple-500 shadow-sm shadow-purple-500/40' }}">
                    <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ route('admin.jadwal.index') }}"
                class="flex items-center px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('admin.jadwal.*') ? 'bg-teal-500 shadow-md shadow-teal-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('admin.jadwal.*') ? 'bg-white/25' : 'bg-teal-500 shadow-sm shadow-teal-500/40' }}">
                    <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div x-data="{ open: {{ request()->routeIs('absensi.*') ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('absensi.*') ? 'bg-sky-500 shadow-md shadow-sky-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group focus:outline-none">
                    <div class="flex items-center">
                        <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('absensi.*') ? 'bg-white/25' : 'bg-sky-500 shadow-sm shadow-sky-500/40' }}">
                            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" class="mt-1 ml-3 pl-3 border-l-2 border-slate-100 dark:border-zinc-700 space-y-1" style="{{ request()->routeIs('absensi.*') ? '' : 'display: none;' }}">
                    <a href="{{ route('absensi.scan.masuk.page') }}"
                        ...
                        <div class="w-6 h-6 rounded-lg flex items-center justify-center {{ request()->routeIs('absensi.scan.masuk.page') ? 'bg-emerald-500' : 'bg-emerald-100 dark:bg-emerald-900/50' }}">
                    ...
                    <a href="{{ route('absensi.scan.pulang.page') }}"
                        ...
                        <div class="w-6 h-6 rounded-lg flex items-center justify-center {{ request()->routeIs('absensi.scan.pulang.page') ? 'bg-amber-500' : 'bg-amber-100 dark:bg-amber-900/50' }}">
                    ...
                    <a href="{{ route('absensi.rekap') }}"
                        ...
                        <div class="w-6 h-6 rounded-lg flex items-center justify-center {{ request()->routeIs('absensi.rekap') ? 'bg-purple-500' : 'bg-purple-100 dark:bg-purple-900/50' }}">
            ...
            <a href="{{ route('admin.pengumuman.index') }}"
                class="flex items-center px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('admin.pengumuman.*') ? 'bg-pink-500 shadow-md shadow-pink-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('admin.pengumuman.*') ? 'bg-white/25' : 'bg-pink-500 shadow-sm shadow-pink-500/40' }}">
                    <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
