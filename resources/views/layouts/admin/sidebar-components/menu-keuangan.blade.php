    ...
    <div class="mb-4">
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('keuangan.pembayaran.index') }}"
                class="flex items-center px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('keuangan.pembayaran.*') ? 'bg-emerald-500 shadow-md shadow-emerald-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('keuangan.pembayaran.*') ? 'bg-white/25' : 'bg-emerald-500 shadow-sm shadow-emerald-500/40' }}">
            ...
            <div x-data="{ open: {{ request()->routeIs('keuangan.pemasukan.*') ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('keuangan.pemasukan.*') ? 'bg-green-500 shadow-md shadow-green-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group focus:outline-none">
                    <div class="flex items-center">
                        <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('keuangan.pemasukan.*') ? 'bg-white/25' : 'bg-green-500 shadow-sm shadow-green-500/40' }}">
                            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" class="mt-1 ml-3 pl-3 border-l-2 border-slate-100 dark:border-zinc-700 space-y-1" style="{{ request()->routeIs('keuangan.pemasukan.*') ? '' : 'display: none;' }}">
                    ...
                    <a href="{{ route('keuangan.pemasukan.kategori.index') }}"
                        ...
                        <div class="w-6 h-6 rounded-lg flex items-center justify-center {{ request()->routeIs('keuangan.pemasukan.kategori.*') ? 'bg-green-500' : 'bg-green-100 dark:bg-green-900/50' }}">
            ...
            <div x-data="{ open: {{ request()->routeIs('keuangan.pengeluaran.*') ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('keuangan.pengeluaran.*') ? 'bg-red-500 shadow-md shadow-red-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group focus:outline-none">
                    <div class="flex items-center">
                        <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('keuangan.pengeluaran.*') ? 'bg-white/25' : 'bg-red-500 shadow-sm shadow-red-500/40' }}">
                            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" class="mt-1 ml-3 pl-3 border-l-2 border-slate-100 dark:border-zinc-700 space-y-1" style="{{ request()->routeIs('keuangan.pengeluaran.*') ? '' : 'display: none;' }}">
                    <a href="{{ route('keuangan.pengeluaran.index') }}"
                        ...
                        <div class="w-6 h-6 rounded-lg flex items-center justify-center {{ request()->routeIs('keuangan.pengeluaran.index') ? 'bg-red-500' : 'bg-red-100 dark:bg-red-900/50' }}">
                    ...
                    <a href="{{ route('keuangan.pengeluaran.kategori.index') }}"
                        ...
                        <div class="w-6 h-6 rounded-lg flex items-center justify-center {{ request()->routeIs('keuangan.pengeluaran.kategori.*') ? 'bg-red-500' : 'bg-red-100 dark:bg-red-900/50' }}">
            ...
            <a href="{{ route('keuangan.tagihan.index') }}"
                class="flex items-center px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('keuangan.tagihan.*') ? 'bg-amber-500 shadow-md shadow-amber-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('keuangan.tagihan.*') ? 'bg-white/25' : 'bg-amber-500 shadow-sm shadow-amber-500/40' }}">
                    <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ route('bank.index') }}"
                class="flex items-center px-3 py-1.5 rounded-2xl transition-all duration-200 {{ request()->routeIs('bank.*') ? 'bg-indigo-500 shadow-md shadow-indigo-500/30' : 'hover:bg-slate-100 dark:hover:bg-zinc-800' }} group">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mr-3 {{ request()->routeIs('bank.*') ? 'bg-white/25' : 'bg-indigo-500 shadow-sm shadow-indigo-500/40' }}">
                    <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
