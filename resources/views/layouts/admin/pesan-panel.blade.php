{{--
    Panel Pesan: ditampilkan di footer atas area konten utama (hanya di dashboard admin/staff)
...
--}}
@if(isset($pendaftaranMenunggu) || isset($pembayaranBelumDikonfirmasi))
@php
    $totalPesan = ($pendaftaranMenunggu ?? 0) + ($pembayaranBelumDikonfirmasi ?? 0);
@endphp
