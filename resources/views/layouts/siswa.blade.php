...
<head>
    ...
    <style>
        ...
        .dark {
            ...
            --bg-body: #1e293b;
            --primary: #78BBB0;
            --primary-light: rgba(56, 135, 130, 0.18);
        }
    </style>
    <script>
...
<body class="bg-slate-50 dark:bg-slate-900 flex h-screen overflow-hidden text-slate-800 dark:text-slate-100">
    ...
    <div :class="!sidebarOpen ? 'sidebar-closed' : ''" class="main-content-wrapper flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-950 p-4 sm:p-6 lg:p-8 pb-24 lg:pb-8 custom-scrollbar transition-colors duration-200">
