...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-br from-white to-[#78BBB0]/20 dark:from-zinc-900 dark:to-[#388782]/30 rounded-xl shadow-sm border border-slate-100 dark:border-[#388782]/30 p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <a href="{{ route('guru.ujian.create') }}"
                class="bg-gradient-to-r from-[#388782] to-[#206D6C] text-white px-5 py-2.5 rounded-xl hover:from-[#206D6C] hover:to-[#0F5253] flex items-center gap-2 text-sm font-semibold shadow-md shadow-[#388782]/25 transition-all duration-200 hover:shadow-lg">
    ...
    <div class="flex gap-2 overflow-x-auto pb-1">
        ...
        <a href="{{ route('guru.ujian.index') }}" class="px-4 py-2 rounded-xl text-sm font-medium whitespace-nowrap transition-colors {{ !$s ? 'bg-[#388782] text-white shadow-sm' : 'bg-white dark:bg-zinc-900 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-zinc-700 hover:bg-slate-50 dark:hover:bg-zinc-800' }}">Semua</a>
    ...
    <div class="bg-gradient-to-br from-white to-[#78BBB0]/20 dark:from-zinc-900 dark:to-[#388782]/30 rounded-xl shadow-sm border border-slate-100 dark:border-[#388782]/30 p-16 text-center">
        <div class="w-20 h-20 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[#A2D5CB] to-[#78BBB0] dark:from-[#388782]/40 dark:to-[#206D6C]/40 flex items-center justify-center">
            <svg class="w-10 h-10 text-[#388782] dark:text-[#A2D5CB]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
        </div>
        ...
        <a href="{{ route('guru.ujian.create') }}" class="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-[#388782] to-[#206D6C] text-white px-5 py-2.5 rounded-xl text-sm font-semibold shadow-md shadow-[#388782]/25 transition-all">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
            Buat Ujian Pertama
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        @endphp
        <div class="bg-gradient-to-br from-white to-[#78BBB0]/20 dark:from-zinc-900 dark:to-[#388782]/30 rounded-xl shadow-sm border border-slate-100 dark:border-[#388782]/30 p-5 hover:shadow-md transition-all duration-200 flex flex-col justify-between group">
            <div>
                {{-- Status Badge --}}
            ...
            {{-- Actions --}}
            <div class="flex items-center justify-between mt-4 pt-4 border-t border-slate-100 dark:border-[#388782]/20">
                <a href="{{ route('guru.ujian.show', $ujian->id) }}"
                    class="bg-[#388782] text-white text-xs px-3.5 py-1.5 rounded-lg hover:bg-[#206D6C] font-medium transition-colors shadow-sm">
                    Detail
                </a>
                <div class="flex gap-2">
                    ...
                    @endif
                    <a href="{{ route('guru.ujian.edit', $ujian->id) }}" class="text-xs text-slate-500 dark:text-slate-400 hover:text-[#388782] font-medium">Edit</a>
                </div>
            </div>
        </div>
        @endforeach
