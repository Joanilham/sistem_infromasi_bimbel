...
<div class="relative mb-8 rounded-[1.75rem] overflow-hidden shadow-2xl" x-data="dashboardClock">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-indigo-600 via-blue-600 to-purple-500 animate-gradient-xy"></div>

    {{-- Decorative circles --}}
    <div class="absolute -top-20 -right-20 w-96 h-96 rounded-full bg-white/10 blur-3xl pointer-events-none"></div>
    <div class="absolute -bottom-32 -left-16 w-80 h-80 rounded-full bg-blue-400/20 blur-3xl pointer-events-none"></div>
    ...
    <div class="relative z-10 p-5 md:p-10 flex flex-col xl:flex-row xl:items-center justify-between gap-8">
        ...
        <div class="flex-1">
            <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-5">
                ...
                <span class="text-xs font-semibold tracking-widest text-indigo-100 uppercase">Dashboard Guru</span>
            </div>
            ...
            <p class="text-indigo-100 text-base md:text-lg max-w-xl leading-relaxed">
...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-10">
    ...
    <div class="relative bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-5">
                ...
                <div class="p-2.5 rounded-xl bg-blue-100 text-blue-600 group-hover:scale-110 transition-transform">
        ...
        <div class="absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-blue-400 to-indigo-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500 rounded-b-2xl"></div>
    </div>
    ...
    <div class="relative bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-5">
                ...
                <div class="p-2.5 rounded-xl bg-emerald-100 text-emerald-600 group-hover:scale-110 transition-transform">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="relative bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-5">
                ...
                <div class="p-2.5 rounded-xl bg-purple-100 text-purple-600 group-hover:scale-110 transition-transform">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-purple-400 to-fuchsia-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500 rounded-b-2xl"></div>
    </div>
    ...
    <div class="relative bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-5">
                ...
                <div class="p-2.5 rounded-xl bg-amber-100 text-amber-600 group-hover:scale-110 transition-transform">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
    ...
    <a href="{{ route('guru.jadwal.index') }}"
        class="group relative flex flex-col gap-4 bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl p-6 hover:border-blue-400 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-blue-50/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        <div class="relative z-10 p-3 w-fit rounded-xl bg-blue-100 text-blue-600 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
        </div>
        <div class="relative z-10">
            <h3 class="font-bold text-slate-800 dark:text-slate-100 text-base mb-1 group-hover:text-blue-600 transition-colors">Buat Jadwal</h3>
            <p class="text-sm text-slate-500 leading-snug">Atur dan kelola jadwal mengajar pelajaran Anda.</p>
        </div>
        <div class="absolute bottom-4 right-4 text-blue-500 opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-300">
    ...
    <a href="{{ route('guru.bank-soal.create') }}"
        class="group relative flex flex-col gap-4 bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl p-6 hover:border-emerald-400 hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-300 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-emerald-50/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        <div class="relative z-10 p-3 w-fit rounded-xl bg-emerald-100 text-emerald-600 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-300">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
        </div>
        <div class="relative z-10">
            <h3 class="font-bold text-slate-800 dark:text-slate-100 text-base mb-1 group-hover:text-emerald-600 transition-colors">Tambah Bank Soal</h3>
            <p class="text-sm text-slate-500 leading-snug">Buat kumpulan soal CBT baru untuk siswa.</p>
        </div>
        <div class="absolute bottom-4 right-4 text-emerald-500 opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-300">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
        </div>
    </a>
    ...
    <a href="{{ route('guru.ujian.create') }}"
        class="group relative flex flex-col gap-4 bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl p-6 hover:border-purple-400 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-purple-50/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        <div class="relative z-10 p-3 w-fit rounded-xl bg-purple-100 text-purple-600 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
            </svg>
        </div>
        <div class="relative z-10">
            <h3 class="font-bold text-slate-800 dark:text-slate-100 text-base mb-1 group-hover:text-purple-600 transition-colors">Buat Ujian Baru</h3>
            <p class="text-sm text-slate-500 leading-snug">Rancang dan jadwalkan sesi ujian untuk siswa.</p>
        </div>
        <div class="absolute bottom-4 right-4 text-purple-500 opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-300">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
        </div>
    </a>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-slate-100 dark:border-zinc-800 overflow-hidden">
        <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 dark:bg-zinc-800/50">
            <h3 class="text-lg font-bold text-slate-800 dark:text-slate-100">Jadwal Hari Ini</h3>
            <span class="text-xs font-bold px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full">Hari {{ \Carbon\Carbon::now()->locale('id')->isoFormat('dddd') }}</span>
        </div>
        <div class="divide-y divide-slate-50 dark:divide-zinc-800/50">
            ...
            <div class="p-4 mx-2 my-2 rounded-xl hover:bg-slate-50 dark:hover:bg-zinc-800 border border-transparent hover:border-slate-100 transition-all flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-50 to-blue-50 text-indigo-600 flex flex-col items-center justify-center font-black shadow-inner">
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-slate-100 dark:border-zinc-800 overflow-hidden">
        <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 dark:bg-zinc-800/50">
            ...
            <a href="{{ route('guru.ujian.index') }}" class="text-sm font-bold text-indigo-600 hover:text-indigo-800 transition-colors">Lihat Semua &rarr;</a>
        </div>
        <div class="divide-y divide-slate-50 dark:divide-zinc-800/50">
            ...
            <div class="p-4 mx-2 my-2 rounded-xl hover:bg-slate-50 dark:hover:bg-zinc-800 border border-transparent hover:border-slate-100 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    <div class="text-center px-4 py-1.5 bg-slate-50 rounded-xl border border-slate-100">
                        <p class="text-lg font-black text-slate-700 dark:text-slate-200 leading-none">{{ $ujian->pesertas_count }}</p>
                        <p class="text-[10px] text-slate-400 uppercase tracking-wider font-bold mt-1">Peserta</p>
                    </div>
                    <a href="{{ route('guru.ujian.monitoring', $ujian->id) }}" class="p-2.5 bg-indigo-50 text-indigo-600 hover:bg-indigo-600 hover:text-white rounded-xl transition-all shadow-sm" title="Lihat Rekap Nilai">
            ...
            <div class="p-10 text-center flex flex-col items-center justify-center">
                ...
                <a href="{{ route('guru.ujian.create') }}" class="text-sm text-indigo-600 font-bold mt-2 hover:underline">Buat Ujian Pertama &rarr;</a>
