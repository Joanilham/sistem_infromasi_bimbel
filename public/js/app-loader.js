...
const App = (() => {
  ...
  const Skeleton = {
    show(containerEl) {
      ...
      const isBody = containerEl === document.body || containerEl.tagName === 'BODY';
      
      if (isBody) {
        containerEl.innerHTML = `
          <div style="padding: 24px; display: flex; flex-direction: column; gap: 24px; min-height: 100vh; background: var(--bg-color, #f8fafc); width: 100vw; box-sizing: border-box;">
            <!-- Header Skeleton -->
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; width: 100%;">
              <div class="skeleton skeleton-block" style="width: 250px; height: 40px; border-radius: 8px;"></div>
            ...
            <div style="display: flex; gap: 24px; flex: 1; flex-wrap: wrap; width: 100%;">
              <div class="skeleton skeleton-block" style="flex: 2; min-width: 300px; height: 400px; border-radius: 24px;"></div>
              <div class="skeleton skeleton-block" style="flex: 1; min-width: 300px; height: 400px; border-radius: 24px;"></div>
            </div>
          </div>
        `;
      } else {
        containerEl.innerHTML = `
          <div style="padding: 16px; display: flex; flex-direction: column; gap: 12px; width: 100%; box-sizing: border-box;">
            <div style="display: flex; gap: 12px; align-items: center;">
